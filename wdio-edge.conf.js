...
export const config = {
  ...
  suites: {
    ...
    functional: ["./test/specs/functional-test.spec.js"],
    end2end: ["./test/specs/end2end-ecommerce-test.spec.js"],
    smoke: ["./test/specs/end2end-pom-test.spec.js"],
  },
  //
  // ============
  // Capabilities
  ...
  capabilities: [
    ...
    },*/
    {
      ...
      browserName: "msedge",
      "ms:edgeOptions": {
        args: ["--headless=new", "--window-size=maximizeWindow"],
      },
    },
  ],
  //
  ...
  onPrepare: function (config, capabilities) {
    ...
    if (fs.existsSync(resultsDir)) {
      ...
      console.log("✅ Cleaned up previous Allure results.");
    } else {
      console.log("ℹ️ No previous Allure results to remove.");
    }
  },
  /**
